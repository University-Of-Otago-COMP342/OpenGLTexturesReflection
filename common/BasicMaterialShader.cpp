...
void BasicMaterialShader::setLightColor(glm::vec3 lightCol){
    m_diffuseLightColID = glGetUniformLocation(programID, "newDiffuseLightColor");
    glUniform3f(m_diffuseLightColID, lightCol.x, lightCol.y, lightCol.z);
    }
